        ...
        <>
            ...
            <div className="container mx-auto px-4 py-8 sm:py-10 lg:px-8">
                ...
                <div className="mt-8 bg-[#181818] p-6 sm:p-8 rounded-xl shadow-lg">
                    <h2 className="text-2xl font-bold mb-5 text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400">Order Summary</h2>
                    ...
                    <div className="mt-6">
                        <h2 className="text-2xl font-bold mb-3">Shipping</h2>
                    ...
                    <div className="mt-6">
                        ...
                        <p className="text-gray-300"><strong>Method:</strong> {cart.paymentMethod}</p>
                    </div>
                </div>
