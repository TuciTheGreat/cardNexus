        ...
        <div className="container flex flex-col md:flex-row justify-center items-start flex-wrap mx-auto mt-8 px-4">
            {cartItems.length === 0 ? (
                <div className="text-center mt-8 flex justify-center items-start h-screen">
                    <p className="text-xl">Your cart is empty <Link to="/shop" className="text-pink-500">Go To Shop</Link></p>
                </div>
            ) : (
                <>
                    <div className="flex flex-col w-full md:w-3/4">
                        ...
                        {cartItems.map((item) => (
                            <div key={item._id} className="flex flex-col md:flex-row items-center md:items-start mb-4 pb-2 border-b border-gray-700">
