...
const UserOrder = () => {
    ...
    return (
        <div className="min-h-screen bg-black text-gray-100 flex justify-center items-start overflow-hidden">
            <div className="container max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-black mt-0 pt-0">
                <h2 className="text-3xl font-bold text-pink-400 mb-8 text-center">My Orders</h2>
                    ...
                    <div className="overflow-x-auto pb-4 bg-transparent">
                        <table className="w-full min-w-[800px] mx-auto border border-gray-700 rounded-lg shadow-lg bg-transparent">
                            <thead className="bg-gray-800">
                                <tr>
                                    <th className="p-4 text-left text-sm font-semibold text-pink-300">Image</th>
                                    <th className="p-4 text-left text-sm font-semibold text-pink-300">Order ID</th>
                                    <th className="p-4 text-left text-sm font-semibold text-pink-300">Date</th>
                                    <th className="p-4 text-right text-sm font-semibold text-pink-300">Total</th>
                                    <th className="p-4 text-center text-sm font-semibold text-pink-300">Payment</th>
                                    <th className="p-4 text-center text-sm font-semibold text-pink-300">Delivery</th>
                                    <th className="p-4 text-center text-sm font-semibold text-pink-300">Actions</th>
                                </tr>
                            </thead>
